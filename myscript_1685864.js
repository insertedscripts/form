...
var goal = document.querySelectorAll("#myitemlist_myitemlist131634 .widgettitle > span").innerHTML;
...
document.querySelectorAll("#myitemlist_myitemlist132095 .widgettitle > span").innerHTML = subm*goal;
