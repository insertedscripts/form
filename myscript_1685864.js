document.getElementById("AutoNumber1").onmouseover = function percentage() {
...
var goal = document.querySelectorAll("#myitemlist_myitemlist131634 .widgettitle span:first").innerHTML;
...
document.querySelectorAll("#myitemlist_myitemlist132095 .widgettitle span:first").innerHTML = subm*goal;
