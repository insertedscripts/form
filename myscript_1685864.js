...
var subm = document.querySelectorAll("#myitemlist_myitemlist131630 h2").innerText;
//var $subm = $("#myitemlist_myitemlist131630 h2").text();
//var subm = document.getElementById("myitemlist_myitemlist131630").innerHTML;
var goal = document.querySelectorAll("#myitemlist_myitemlist131634 .widgettitle > span").innerText;
