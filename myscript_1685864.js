...
var goal = document.querySelectorAll("#myitemlist_myitemlist131634 .widgettitle").innerHTML;
...
document.querySelectorAll("#myitemlist_myitemlist132095 .widgettitle").innerHTML = subm*goal;
